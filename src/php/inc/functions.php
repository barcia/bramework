 ...
 */
if ( ! function_exists( 'bramework_post_date' ) ) :
	function bramework_post_date() {
 ...
 */
if ( ! function_exists( 'bramework_update_date' ) ) :
	function bramework_update_date() {
 ...
 */
if ( ! function_exists( 'bramework_post_author' ) ) :
	function bramework_post_author( $attr='default' ) {
 ...
 */
if ( ! function_exists( 'bramework_post_category' ) ) :
	function bramework_post_category( $args = ', ' ) {
 ...
 * Prints the tags
 */
if ( ! function_exists( 'bramework_post_tags' ) ) :
	function bramework_post_tags( $args = '' ) {
 ...
 * Prints the comments
 */
if ( ! function_exists( 'bramework_post_comments' ) ) :
	function bramework_post_comments() {
 ...
 */
if ( ! function_exists( 'bramework_pagination' ) ) :
	function bramework_pagination() {

		$args = array(
			'prev_next'          => false,
			'prev_text'          => __('Previous', 'bramework_text'),
			'next_text'          => __('Next', 'bramework_text'),
		);
 ...
 */
if ( ! function_exists( 'bramework_noposts' ) ) :
	function bramework_noposts() {

		$message = __('Sorry, no posts matched your criteria.', 'bramework_text');
 ...
 * Edit post link
 */
if ( ! function_exists( 'bramework_editpost' ) ) :
	function bramework_editpost() {
 ...
 */
if ( ! function_exists( 'bramework_commentsnumber' ) ) :
	function bramework_commentsnumber() {
 ...
 * The wrapper classes
 */
if ( ! function_exists( 'bramework_wrapper_class' ) ) :
	function bramework_wrapper_class( $class='' ) {
		...
		if ( ! empty( $class ) ) {
			...
			if (get_theme_mod('bramework_option_navtype') == 'scroll') {
 ...
 */
function bramework_is_static_front_page() {
